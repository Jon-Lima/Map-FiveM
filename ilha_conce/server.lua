...
fclient = Tunnel.getInterface("ilha_conce")

func = {}
Tunnel.bindInterface("ilha_conce", func)
...
vRP._prepare("getVehicles", "SELECT * FROM vrp_estoque")
...
Citizen.CreateThread(function()
    if not config.customMYSQL then
        ...
        vRP._prepare("nation_conce/isVehicleInConce","SELECT * FROM vrp_estoque WHERE vehicle = @vehicle")

        vRP.prepare("nation_conce/addVehicle","INSERT IGNORE INTO vrp_estoque(vehicle,estoque) VALUES(@vehicle,@estoque)")
        vRP.prepare("nation_conce/removeVehicle","DELETE FROM vrp_estoque WHERE vehicle = @vehicle")

        vRP._prepare("nation_conce/addEstoque","UPDATE vrp_estoque SET estoque = @estoque WHERE vehicle = @vehicle")
        vRP._prepare("nation_conce/removeEstoque","UPDATE vrp_estoque SET estoque = @estoque WHERE vehicle = @vehicle")

        vRP._prepare("nation_conce/addCustomEstoque","UPDATE vrp_estoque SET estoque = @estoque WHERE vehicle = @vehicle")
        vRP._prepare("nation_conce/removeCustomEstoque","UPDATE vrp_estoque SET estoque = estoque - 1 WHERE vehicle = @vehicle")
    end
