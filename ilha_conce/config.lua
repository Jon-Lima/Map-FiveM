...
config = {}
Proxy.addInterface("ilha_conce", config)


config.imgDir = "http://127.0.0.1/images/img_conce/" -- DIRETORIO DAS IMAGENS DOS VEÍCULOS
...
config.logo = "https://cdn.discordapp.com/icons/647986326137864257/a_45feb7245fcba541948868996133356e.png" -- LOGO DO SERVIDOR
...
config.descontos = {
	{ perm = "manager.permissao", porcentagem = 50 }
}
...
-------------------------------
 ...
 vRP._prepare("nation_conce/getConceVehicles","SELECT * FROM vrp_estoque WHERE estoque > 0")
